...
class Mat44{
	...
	template <typename T>
	bool Mat44<T> :: operator==(Mat44<T> M){
	    for(int i = 0; i < 4; i++)
	        for (int j = 0; j < 4; j++)
	            if(M[i][j] != data[i][j])
	                return false;
	...
	template <typename T>
	Mat44<T> Mat44<T> :: operator*(float scale) {
		float x[4][4];
		for (int i = 0;i < 4;i++) {
			for (int j = 0;j < 4;j++) {
...
template <typename T>
inline Vec3<T> Vec3<T> :: operator/(double v){
	return *this * (1.0 / v);
...
template <typename T>
inline double Vec3<T> :: Length(){
	return (double) sqrt(_x * _x + _y * _y + _z * _z);
}


template <typename T>
inline double Vec3<T> ::LengthSquared(){
...
template <typename T>
inline const Vec3<T> operator*(double v, const Vec3<T>& u){
	return Vec3<T>(u.x() * v, u.y() * v, u.z() * v);
}

template <typename T>
inline Vec3<T> operator*(const Vec3<T>& u, double v){
	return v * u;
}

template <typename T, typename J>
inline Vec3<T>  operator*(const Vec3<T>& u, const Vec3<J>& v){
	return Vec3<T>(u.x() * v.x(), u.y() * v.y(), u.z() * v.z());
}

template <typename T>
inline Vec3<T> operator-(double v, const Vec3<T>& u){
	return Vec3<T>(u.x() - v, u.y() - v, u.z() - v);
}
...
template <typename T>
inline Vec2<T> Vec2<T> :: operator/(double v){
	return *this * (1.0 / v);
	//return Vec3<T>(_x * v, _y * v, _z * v);
}
...
template <typename T>
inline double Vec2<T> :: Length(){
	return (double) sqrt(_x * _x + _y * _y);
}


template <typename T>
inline double Vec2<T> ::LengthSquared(){
...
template <typename T>
inline const Vec2<T> operator*(double v, const Vec2<T>& u){
	return Vec2<T>(u.x() * v, u.y() * v);
}

template <typename T>
inline Vec2<T> operator*(const Vec2<T>& u, double v){
	return v * u;
}

template <typename T, typename J>
inline Vec2<T>  operator*(const Vec2<T>& u, const Vec2<J>& v){
	return Vec2<T>(u.x() * v.x(), u.y() * v.y());
}

template <typename T>
inline Vec2<T> operator-(double v, const Vec2<T>& u){
	return Vec2<T>(u.x() - v, u.y() - v);
}
